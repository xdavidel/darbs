#!/bin/sh
# David's Auto Rice Boostrapping Script (DARBS)
# by David Delarosa
# credits to:  Luke Smith <luke@lukesmith.xyz>
# License: GNU GPLv3
...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://gitlab.com/xdavidel/dotfiles.git"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to David's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured i3wm Arch Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
	}
